...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeValueFromQValues(self, state):
        ...
        val = self.getQValue(state, policy)
    ...
    def update(self, state, action, nextState, reward):
        ...
        updates = curQ + self.alpha * (reward + self.discount * newQ - curQ)

        self.qVal[(state, action)] = updates
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        diff = (reward + self.discount * newVal) - curQ

        #update each
        for feature in featureVector:
            self.weights[feature] += diff * self.alpha * featureVector[feature]
